...
//On farbique la fonction qui va sauvegarder les données

var StaffSave = new Array();
//test de la sauvegarde de parto
StaffSave.push({StaffName: "Testsauvegarde", myStaff: ["do5","mi5","do6"]});
...
function Save() {
    ...
    StaffSave=JSON.parse((localStorage.getItem("all_staffs")));
    StaffSave.push(JSON.stringify({StaffName: StaffName, StaffNotes: myStaff}));
    localStorage.setItem('all_staffs',JSON.stringify(StaffSave));*/
